/*
  ...
  - Added the required column `description_text` to the `EventsData` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_EventsData" ("access_link", "access_link_text", "access_type", "audience", "average_rating", "contact_facebook", "contact_mail", "contact_twitter", "contact_url", "cover_alt", "cover_credit", "cover_url", "date_description", "date_end", "date_start", "id", "info", "lead_text", "placeId", "price_detail", "price_type", "title", "updatedAt", "url") SELECT "access_link", "access_link_text", "access_type", "audience", "average_rating", "contact_facebook", "contact_mail", "contact_twitter", "contact_url", "cover_alt", "cover_credit", "cover_url", "date_description", "date_end", "date_start", "id", "info", "lead_text", "placeId", "price_detail", "price_type", "title", "updatedAt", "url" FROM "EventsData";
