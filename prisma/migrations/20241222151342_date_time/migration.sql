/*
  ...
  - You are about to alter the column `date_end` on the `EventsData` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
  - You are about to alter the column `date_start` on the `EventsData` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
